...
<body>
    <header class="d-flex justify-content-between pt-3 pe-3 pt-xl-4 pe-xl-4">
        ...
        <div>
            <!-- Start: Profile Button --><a class="btn d-inline-flex align-items-center btn-add-funds p-0 me-3" role="button" href="#"><img class="flex-shrink-0" width="40" height="46" src="{{ url('icon%20-%20add.png') }}"><span class="fw-bold text-start text-light ms-1" style="line-height: 18px;">ADD&nbsp;<br>FUNDS</span></a><!-- End: Profile Button -->
